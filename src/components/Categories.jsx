    ...
    return (
        <div className="mt-5">
            <div className="container-fluid pt-4">
                <div className="container border-bottom border-2 pb-5">
                    <div>
                        <div className="row">
                            <div className="d-flex align-items-center gap-4 flex-wrap">
                                ...
                                <h3 className="text-danger fs-4">Categories</h3>
                            </div>
                        </div>
                        <div className="cat-head d-flex justify-content-between mt-4">
                            <h4 className="cat-h4 text-capitalize fs-md-2">browse by category</h4>
                            <div className="d-flex justify-content-center gap-2 col-md-3 col-12 mt-3 mt-md-0">
                                <button className="border-0 bg-transparent pagination-button"><svg width="46" height="46" viewBox="0 0 46 46" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div className="mt-5">
                        <div className="row gap-4">
                            <div className="cat-box col border border-2 d-flex flex-column align-items-center justify-content-center py-4 rounded-3">
                                <svg width="56" height="56" viewBox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <g clipPath="url(#clip0_910_868)">
                                    ...
                                    <defs>
                                        <clipPath id="clip0_910_868">
                                            <rect width="56" height="56" fill="white" />
                                        </clipPath>
                                    </defs>
                                </svg>
                                <h5 className="mt-3 fs-6">Phones</h5>
                            </div>
                            <div className="cat-box col border border-2 d-flex flex-column align-items-center justify-content-center py-4 rounded-3">
                                <svg width="56" height="56" viewBox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <g clipPath="url(#clip0_910_613)">
                                ...
                                <h5 className="mt-3 fs-6">Computers</h5>
                            </div>
                            <div className="cat-box col border border-2 d-flex flex-column align-items-center justify-content-center py-4 rounded-3">
                                <svg width="56" height="56" viewBox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <g clipPath="url(#clip0_910_629)">
                                    ...
                                    <defs>
                                        <clipPath id="clip0_910_629">
                                            <rect width="56" height="56" fill="white" />
                                        </clipPath>
                                    </defs>
                                </svg>

                                <h5 className="mt-3 fs-6">SmartWatch</h5>
                            </div>
                            <div className="cat-box col border border-2 d-flex flex-column align-items-center justify-content-center py-4 rounded-3">
                                <svg width="56" height="56" viewBox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <g clipPath="url(#clip0_910_6)">
                                ...
                                <h5 className="mt-3 fs-6">Camera</h5>
                            </div>

                            <div className="cat-box col border border-2 d-flex flex-column align-items-center justify-content-center py-4 rounded-3">
                                <svg width="56" height="56" viewBox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <g clipPath="url(#clip0_910_644)">
                                ...
                                <h5 className="mt-3 fs-6">Headphones</h5>
                            </div>
                            <div className="cat-box col border border-2 d-flex flex-column align-items-center justify-content-center py-4 rounded-3">
                                <svg width="56" height="56" viewBox="0 0 56 56" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <g clipPath="url(#clip0_910_809)">
                                    ...
                                    <defs>
                                        <clipPath id="clip0_910_809">
                                            <rect width="56" height="56" fill="white" />
                                        </clipPath>
                                    </defs>
                                </svg>

                                <h5 className="mt-3 fs-6">Gaming</h5>
                            </div>
                        </div>
                    </div>
                </div>
